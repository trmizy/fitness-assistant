...
<a id="merged-advanced-training-methods-implementation-report"></a>

## Consolidated reference: ADVANCED_TRAINING_METHODS_IMPLEMENTATION_REPORT.md
...
[the continuation list](STATUS.md).
