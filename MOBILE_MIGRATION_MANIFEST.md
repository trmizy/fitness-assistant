...
| CL-04 | `Services.tsx` | `pages/client/ServicesPage.tsx` (host 5 trang con) | `(client)/services/index.tsx` (tab host) | user + gym (xem CL-06..11) | client, pt | 01,02 | tab Tìm PT/Đặt lịch/Hợp đồng/Phòng gym/Hội viên | nhiều | không | không | 7 | **đang làm (17/9)** — `services/index.tsx`, 4 tab pill đúng thiết kế. **Xong: Tìm PT, Phòng gym, Hội viên**; tab Hợp đồng đang dựng tiếp. |
