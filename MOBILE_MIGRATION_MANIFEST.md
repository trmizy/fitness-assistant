...
| CL-04 | `Services.tsx` | `pages/client/ServicesPage.tsx` (host 5 trang con) | `(client)/services/index.tsx` (tab host) | user + gym (xem CL-06..11) | client, pt | 01,02 | tab Tìm PT/Đặt lịch/Hợp đồng/Phòng gym/Hội viên | nhiều | không | không | 7 | **đang làm (17/9)** — `services/index.tsx` với 4 tab pill đúng bản thiết kế (Tìm PT / Phòng gym / Hội viên / Hợp đồng). Tab **Tìm PT xong**; ba tab còn lại đang dựng tiếp trong Phase 7. |
