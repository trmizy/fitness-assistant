...
| SH-11 | `discover/Discover.tsx` | `pages/client/library/LibraryPage.tsx` | `(client)/library/index.tsx` | fitness: `getExercises`,`foodService.list`,`getMuscleTaxonomy` | client, pt | — | hub 4 mục | không | không | không | 5 | **xong/đã kiểm trên emulator (15/9)** (PARTIAL: preview thực phẩm + kiến thức → Phase 6) |
| SH-12 | `discover/ExerciseLibrary.tsx` | `ExerciseLibraryPage.tsx`+`ExerciseDetailPage.tsx` | `library/exercises/index.tsx`,`[id].tsx` | fitness: `/exercises*` | client, pt | — | filter/video preview | không | không | video player | 5 | **xong/đã kiểm trên emulator (15/9)** (PARTIAL: video preview → Phase 14) |
...
| SH-14 | `discover/GlobalSearch.tsx` | `GlobalSearchPage.tsx` | `library/search.tsx` hoặc `search.tsx` cấp client | fitness: `getExercises`,`foodService.search`,`getMuscleTaxonomy` | client, pt | — | kết quả gộp 4 nguồn | không | không | không | 5 | **xong/đã kiểm trên emulator (15/9)** (PARTIAL: nhóm thực phẩm + bài viết → Phase 6) |
...
| CL-03 | `Nutrition.tsx` | `pages/client/NutritionPage.tsx` | `(client)/nutrition/index.tsx` | fitness: `/nutrition*`,`/food*` | client, pt | — | macro rings/meals | không | không | không | 6 | chưa làm/chưa kiểm |
...
| CL-14 | `InBody.tsx` | `pages/client/InBodyModule.tsx` | `(client)/inbody/index.tsx`,`history.tsx` | user (`inbodyService`) + fitness (`trainingCycleService`) | client, pt | — | capture/history/compare | không | không | camera | 6 | chưa làm/chưa kiểm |
...
| CL-19 | `NutritionExtras.tsx` (`NutritionGoals`,`MonthlySummary`) | Section trong `NutritionPage.tsx`, không phải route riêng | nested trong `nutrition/index.tsx` | fitness: `/nutrition/goals*` | client, pt | — | goal presets | không | không | không | 6 | chưa làm/chưa kiểm |
