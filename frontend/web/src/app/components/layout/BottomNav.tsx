...
export function BottomNav() {
  ...
  const navItems =
    isPT && activeView === "pt"
      ? [
          { label: "Dash", icon: GyminiDashboardIcon, to: "/pt/dashboard" },
          { label: "Khách", icon: GyminiUsersIcon, to: "/pt/clients" },
          { label: "Duyệt", icon: GyminiPlanIcon, to: "/pt/plans" },
          { label: "Chat", icon: GyminiChatIcon, to: "/pt/chat" },
          { label: "Hồ sơ", icon: GyminiProfileIcon, to: "/pt/profile" },
        ]
      : [
          { label: "Dash", icon: GyminiDashboardIcon, to: "/client/dashboard" },
          { label: "Tập", icon: GyminiWorkoutIcon, to: "/client/workout" },
          { label: "Ăn", icon: GyminiNutritionIcon, to: "/client/nutrition" },
          { label: "Chat", icon: GyminiChatIcon, to: "/client/chat" },
