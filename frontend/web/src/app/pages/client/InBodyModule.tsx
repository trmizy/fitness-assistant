...
export function InBodyModule() {
  ...
  const trends = [...history]
    .sort((a: any, b: any) =>
      measurementDateKey(a).localeCompare(measurementDateKey(b)),
    )
    .map((h: any) => {
      const measureDate = parseMeasurementDate(h);
      return {
        date: measureDate.toLocaleDateString("vi-VN", {
          day: "2-digit",
          month: "2-digit",
        }),
  ...
  const handleManualSave = (e: React.FormEvent) => {
    ...
    const entry = {
      ...
      // Segmental
      rightArmMuscle: data.rightArmMuscle
        ? parseFloat(data.rightArmMuscle)
        : undefined,
      leftArmMuscle: data.leftArmMuscle
        ? parseFloat(data.leftArmMuscle)
        : undefined,
      trunkMuscle: data.trunkMuscle ? parseFloat(data.trunkMuscle) : undefined,
      rightLegMuscle: data.rightLegMuscle
        ? parseFloat(data.rightLegMuscle)
        : undefined,
      leftLegMuscle: data.leftLegMuscle
        ? parseFloat(data.leftLegMuscle)
        : undefined,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-zinc-500 mt-0.5">
                  Nhập các giá trị từ phiếu InBody của bạn
                </div>
              </div>
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-zinc-500 mt-0.5">
                  Chụp ảnh phiếu InBody — AI trích xuất dữ liệu
                </div>
              </div>
              <ArrowRight className="w-4 h-4 text-zinc-600 group-hover:text-green-400 ml-auto transition-colors" />
            </button>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              return (
                <div
                  key={m.label}
                  className={`${m.bg} rounded-xl p-4 border ${m.border}`}
                >
                  ...
                  <div
                    className={`text-xs mt-1 flex items-center gap-1 ${improved ? "text-green-400" : "text-red-400"}`}
                  >
                    {improved ? (
          ...
          <div className="space-y-2">
            {history.slice(0, 3).map((r: any, i: number) => {
              ...
              return (
                <div
                  key={r.id}
                  className={`flex items-center gap-4 p-3 rounded-xl border ${i === 0 ? "bg-green-500/5 border-green-500/15" : "glass-panel"}`}
                >
                  <div className="text-sm font-semibold text-zinc-200 w-28 flex-shrink-0">
                    {formatMeasurementDate(r)}
                    {i === 0 && (
                      <span className="ml-1 text-xs bg-green-500/10 text-green-400 px-1.5 py-0.5 rounded-full border border-green-500/20">
                        Mới nhất
                      </span>
                    )}
                  </div>
                  <div className="flex gap-4 text-xs text-zinc-500">
                    ...
                    <span className="text-green-400 font-semibold">
                      {r.muscleMass}kg cơ bắp
                    </span>
                    <span className="text-orange-400">{r.bodyFatPct}% BF</span>
                  </div>
                  <span
                    className={`ml-auto inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full font-semibold border ${cfg.color}`}
                  >
          ...
          {manualStep === "done" ? (
            <div className="glass-panel rounded-xl p-10 text-center">
              ...
              <p className="text-zinc-500 text-sm mb-5">
                Dữ liệu thành phần cơ thể của bạn đã được ghi lại thành công.
              </p>
            ...
            <>
              <div className="flex items-center gap-3 bg-violet-500/8 border border-violet-500/20 rounded-xl px-4 py-3">
                ...
                <p className="text-sm text-violet-300">
                  Nhập trực tiếp các giá trị InBody của bạn. Các trường có dấu *
                  là bắt buộc.
                </p>
              </div>
              ...
              <form onSubmit={handleManualSave} className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-4 py-2.5 border border-zinc-700/60 text-zinc-400 text-sm font-semibold rounded-xl hover:bg-zinc-800 transition-colors"
                  >
                    Hủy
                  </button>
                  <button
        ...
        <div className="max-w-xl mx-auto space-y-4">
            ...
            {[
              ...
              return (
                <div key={s.key} className="flex items-center gap-1.5 flex-1">
                  ...
                  <span
                    className={`text-xs hidden sm:block font-medium ${active ? "text-green-400" : "text-zinc-600"}`}
                  >
                    {s.label}
                  </span>
                  {i < 4 && (
                    <div
                      className={`flex-1 h-0.5 rounded-full transition-all ${done ? "bg-green-500" : "bg-zinc-800"}`}
                    />
                  )}
                </div>
              );
            ...
            <div
              ...
              className={`border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-all ${
                dragOver
                  ...
                  : "border-zinc-700 hover:border-green-500/50 hover:bg-zinc-800/40"
              }`}
            >
              <input
                type="file"
              ...
              <h3 className="text-zinc-200 font-bold mb-1">
                Tải ảnh phiếu InBody
              </h3>
              <p className="text-zinc-500 text-sm mb-4">
                Kéo thả hoặc bấm để chọn ảnh phiếu InBody
              </p>
              <div className="flex items-center gap-2 justify-center">
                <span className="text-xs text-zinc-600 bg-zinc-800 border border-zinc-700/50 px-2 py-1 rounded-full">
                  JPG
                </span>
                <span className="text-xs text-zinc-600 bg-zinc-800 border border-zinc-700/50 px-2 py-1 rounded-full">
                  PNG
            ...
            <div className="glass-panel rounded-xl overflow-hidden">
              ...
              <div className="flex gap-2 p-4 border-t border-zinc-800/60">
                <button
                  ...
                  className="flex-1 py-2 border border-zinc-700/60 text-zinc-300 text-sm font-semibold rounded-lg hover:bg-zinc-800/60"
                >
                  Chọn ảnh khác
                </button>
                <button
          ...
          {uploadStep === "processing" && (
            <div className="bg-zinc-900 border border-zinc-800/60 rounded-xl p-10 text-center">
              ...
              <p className="text-zinc-500 text-sm">
                Đang phân tích ảnh phiếu InBody của bạn
              </p>
            ...
            <div className="glass-panel rounded-xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 bg-amber-500/8 border-b border-amber-500/20">
                ...
                <span className="text-sm text-amber-300 font-semibold">
                  Kiểm tra dữ liệu trích xuất — chỉnh sửa nếu cần trước khi lưu
                </span>
              </div>
              <div className="p-4 space-y-4">
                ...
                >
                  ...
                  <p className="text-xs text-zinc-600 mt-1">
                    Đây là ngày đo trên phiếu InBody, không phải ngày tải ảnh.
                    Upload 2 ảnh cùng ngày đo → chỉ lưu 1 bản ghi, dữ liệu mới
                    nhất.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      },
                      {
                        label: "% Mỡ cơ thể",
                        field: "bodyFatPct",
                        value: extractedData?.bodyFatPct,
                      },
                        ...
                        <div key={f.field}>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setExtractedData({
                                ...extractedData,
                                [f.field]: parseFloat(e.target.value),
                              })
                            }
                            className={inp}
                          />
                ...
                <div>
                  <h4 className="text-xs font-bold text-green-400/80 uppercase tracking-wider mb-2">
                    Cơ theo vùng (kg)
                  </h4>
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      {
                        ...
                        value: extractedData?.rightArmMuscle,
                      },
                      {
                        label: "Tay trái",
                        field: "leftArmMuscle",
                        value: extractedData?.leftArmMuscle,
                      },
                      {
                        label: "Chân phải",
                        field: "rightLegMuscle",
                        value: extractedData?.rightLegMuscle,
                      },
                      {
                        label: "Chân trái",
                        field: "leftLegMuscle",
                        value: extractedData?.leftLegMuscle,
                      },
                      {
                        label: "Thân mình",
                        field: "trunkMuscle",
                        value: extractedData?.trunkMuscle,
                      },
                    ].map(
                      (f: {
                        label: string;
                    ...
                    {[
                      {
                        label: "Tay phải",
                        field: "rightArmFat",
                        value: extractedData?.rightArmFat,
                      },
                      {
                        label: "Tay trái",
                        field: "leftArmFat",
                        value: extractedData?.leftArmFat,
                      },
                      {
                        label: "Chân phải",
                        field: "rightLegFat",
                        value: extractedData?.rightLegFat,
                      },
                      {
                        label: "Chân trái",
                        field: "leftLegFat",
                        value: extractedData?.leftLegFat,
                      },
                      {
                        label: "Thân mình",
                        field: "trunkFat",
                        value: extractedData?.trunkFat,
                      },
                    ].map(
                      (f: {
                        label: string;
              ...
              <div className="flex gap-2 p-4 border-t border-zinc-800/60">
                <button
                  onClick={() => setUploadStep("drop")}
                  className="flex-1 py-2 border border-zinc-700/60 text-zinc-300 text-sm font-semibold rounded-lg hover:bg-zinc-800/60 transition-colors"
                >
                  Chụp lại
                </button>
                <button
          ...
          {uploadStep === "failed" && (
            <div className="bg-zinc-900 rounded-xl border border-red-500/20 p-8 text-center">
              ...
              <p className="text-zinc-500 text-sm mb-5">
                AI không thể đọc đủ dữ liệu từ ảnh này. Hãy thử ảnh rõ hơn hoặc
                nhập thủ công.
              </p>
              <div className="flex gap-3 justify-center">
                <button
          ...
          {uploadStep === "done" && (
            <div className="glass-panel rounded-xl p-10 text-center">
              ...
              <p className="text-zinc-500 text-sm mb-5">
                Dữ liệu thành phần cơ thể đã được trích xuất và xác nhận thành
                công.
              </p>
              <div className="flex gap-3 justify-center">
                <button
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(statusConfig).map(
              ([k, cfg]: [
                ...
                <span
                  key={k}
                  className={`inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full font-semibold border ${cfg.color}`}
                >
                  <div className={`w-1.5 h-1.5 rounded-full ${cfg.dot}`} />
                  {cfg.label}
                </span>
          ...
          <div className="glass-panel rounded-xl overflow-hidden">
            <div className="px-4 py-3 border-b border-zinc-800/60 flex items-center justify-between">
              <h4 className="text-sm font-semibold text-zinc-200">
                Lịch sử InBody ({history.length} bản ghi)
              </h4>
              <button
                  ...
                  {history.length > 0 ? (
                    history.map((r: any, i: number) => {
                      ...
                      return (
                        <tr
                          key={r.id}
                          className={`border-b border-zinc-800/40 last:border-0 hover:bg-zinc-800/30 transition-colors ${i === 0 ? "bg-green-500/5" : ""}`}
                        >
                          <td className="px-4 py-3 text-sm font-semibold text-zinc-200">
                            {formatMeasurementDate(r)}
                            {i === 0 && (
                              <span className="ml-1.5 text-xs bg-green-500/10 text-green-400 px-1.5 py-0.5 rounded-full border border-green-500/20">
                                Mới nhất
                              </span>
                            )}
                          </td>
                          ...
                          <td className="px-4 py-3 text-sm text-rose-400 font-semibold">
                            {r.bodyFatPct}%
                          </td>
                          <td className="px-4 py-3">
                            <span
                              className={`inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full font-semibold border ${cfg.color}`}
                            >
                              <div
          ...
          {history.length < 2 ? (
            <div className="glass-panel rounded-xl p-10 text-center">
              ...
              <p className="text-zinc-600 text-sm">
                Bạn cần ít nhất 2 bản ghi InBody để so sánh.
              </p>
            </div>
          ) : (
            <>
                  ...
                  >
                    {history.map((h: any, i: number) => (
                      <option key={h.id} value={i}>
                        {formatMeasurementDate(h)}
                      </option>
                    ))}
                  </select>
                </div>
                <span className="text-zinc-600 text-sm self-center hidden sm:block font-bold">
                  vs
                </span>
                <div>
                  <label className="text-xs text-zinc-500 mb-1 block uppercase tracking-wider">
                      ...
                      <div className="flex items-end justify-between">
                        <div>
                          ...
                          <div className="text-xs text-zinc-600">
                            {formatMeasurementDate(history[compareA])}
                          </div>
                        </div>
                        <div className="text-right">
                          ...
                          <div className="text-xs text-zinc-600">
                            {formatMeasurementDate(history[compareB])}
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart
                    data={[
                      {
                        metric: "Weight",
                        A: history[compareA]?.weight || 0,
                        B: history[compareB]?.weight || 0,
                      },
                      {
                        metric: "Muscle",
                        A: history[compareA]?.muscleMass || 0,
                        B: history[compareB]?.muscleMass || 0,
                      },
                      {
                        metric: "Fat",
                        A: history[compareA]?.bodyFat || 0,
                        B: history[compareB]?.bodyFat || 0,
                      },
                    ]}
                  >
                    <CartesianGrid strokeDasharray="3 3" stroke="#27272a" />
                    ...
                    <Bar
                      ...
                      fill="#22c55e"
                      radius={[4, 4, 0, 0]}
                      name={formatMeasurementDate(history[compareA])}
                    />
                    <Bar
                      dataKey="B"
                      fill="#3f3f46"
                      radius={[4, 4, 0, 0]}
                      name={formatMeasurementDate(history[compareB])}
                    />
                  </BarChart>
                </ResponsiveContainer>
              </SectionCard>
