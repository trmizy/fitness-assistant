/* eslint-disable @typescript-eslint/array-type -- Chép nguyên văn từ web
   (frontend/web/src/app/pages/client/library/nutritionKnowledge.ts) để hai client không bao giờ
   giải thích khác nhau về cùng một khái niệm. Giữ y nguyên để còn diff được khi web sửa nội dung. */
