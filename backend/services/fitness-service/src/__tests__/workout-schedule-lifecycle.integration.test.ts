...
// day — the two disagree for ~7 hours of every 24 (UTC 17:00-23:59), during
// which a UTC-only "today" reads as "yesterday" per the real lock check and
// trips SCHEDULE_DATE_LOCKED — a real, previously-latent bug in this exact
// helper (verified reproducing), not the lock logic itself.
