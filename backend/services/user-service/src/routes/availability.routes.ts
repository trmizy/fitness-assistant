...
router.get(
  "/me",
  authMiddleware,
  availabilityController.getMyAvailability as any,
);
...
router.put(
  "/me",
  authMiddleware,
  roleMiddleware(["PT", "ADMIN"]),
  availabilityController.setAvailability as any,
);

router.get(
  "/me/exceptions",
  authMiddleware,
  availabilityController.getExceptions as any,
);
router.post(
  "/me/exceptions",
  authMiddleware,
  roleMiddleware(["PT", "ADMIN"]),
  availabilityController.addException as any,
);
router.delete(
  "/me/exceptions/:id",
  authMiddleware,
  roleMiddleware(["PT", "ADMIN"]),
  availabilityController.removeException as any,
);
