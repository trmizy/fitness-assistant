export type ApiErrorCode =
  ...
  | "PAYMENT_FAILED"
  | "PERSONALIZED_SERVICE_NOT_FOUND"
  | "PERSONALIZED_SERVICE_FORBIDDEN"
  | "PERSONALIZED_SERVICE_ORDER_NOT_FOUND"
  | "PERSONALIZED_SERVICE_ORDER_FORBIDDEN"
  | "PERSONALIZED_SERVICE_ORDER_INVALID_STATE"
  | "PERSONALIZED_SERVICE_REVISION_LIMIT_REACHED"
  | "PERSONALIZED_SERVICE_REVIEW_NOT_ELIGIBLE"
  | "PERSONALIZED_SERVICE_REVIEW_ALREADY_EXISTS"
  | "PERSONALIZED_SERVICE_REFUND_INVALID_AMOUNT"
  | "PERSONALIZED_SERVICE_REFUND_INVALID_STATE"
  | "PERSONALIZED_SERVICE_REFUND_FAILED"
