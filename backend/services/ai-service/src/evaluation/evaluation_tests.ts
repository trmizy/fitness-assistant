...
export const EVALUATION_TESTS: EvaluationCase[] = [
  {
    ...
    expectedChecks: [
      "mentions chest-focused exercise context",
      "includes dumbbell-compatible suggestions",
    ],
  },
  {
    id: "R02",
    ...
    expectedChecks: [
      "bodyweight context is respected",
      "no machine-only requirement",
    ],
  },
  {
    id: "R03",
    ...
    expectedChecks: [
      "retrieval includes pull and back clues",
      "response differentiates back emphasis",
    ],
  },
  {
    id: "R04",
    ...
    expectedChecks: [
      "compares both movements",
      "states practical recommendation",
    ],
  },
  {
    id: "P01",
    ...
    expectedChecks: [
      "plan aligns with fat loss objective",
      "uses 4 sessions per week",
    ],
  },
  {
    id: "P02",
  ...
  },
  {
    ...
    expectedChecks: [
      "objective resolves to recomposition",
      "balanced training and nutrition guidance",
    ],
  },
  {
    id: "N01",
    ...
    expectedChecks: [
      "includes calorie target",
      "protein carbs fats are numerically consistent",
    ],
  },
  {
    id: "N02",
    ...
    expectedChecks: [
      "calorie target is above maintenance",
      "protein target is high enough",
    ],
  },
  {
    id: "N03",
  ...
  },
  {
    ...
    expectedChecks: [
      "recomp objective stated",
      "macros are realistic and coherent",
    ],
  },
  {
    id: "S01",
    ...
    expectedChecks: [
      "does not encourage training through pain",
      "includes safer movement options",
    ],
  },
  {
    id: "S02",
  ...
  },
  {
    ...
    expectedChecks: [
      ...
      "suggests lower-impact progression",
    ],
  },
  {
    id: "S04",
  ...
  },
  {
    ...
    expectedChecks: [
      "states low confidence due to missing metrics",
      "requests age height weight gender",
    ],
  },
  {
    id: "F03",
    ...
    expectedChecks: [
      "provides conservative baseline",
      "asks for equipment and training days",
    ],
  },
  {
    id: "F04",
    ...
    expectedChecks: [
      "mentions missing body metrics",
      "provides provisional template only",
    ],
  },
];
