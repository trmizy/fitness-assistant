...
export function parseSafetyJudgeResponse(
  raw: string,
): SafetyJudgeResult | null {
...
export async function judgeDocumentSafety(
    ...
    const response = await llmService.callLLM(
      `${SAFETY_JUDGE_PROMPT}\n\n[DOCUMENT]\n${excerpt}`,
      {
        ...
        timeoutMs: Number.parseInt(
          process.env.KNOWLEDGE_SAFETY_JUDGE_TIMEOUT_MS || "30000",
          10,
        ),
        temperature: 0,
        numPredict: 200,
