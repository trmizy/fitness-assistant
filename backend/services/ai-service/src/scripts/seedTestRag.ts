...
const exerciseSeeds: PointSeed[] = [
  {
    ...
    payload: {
      ...
      instructions:
        "Start in a high plank with hands under shoulders, lower under control, then press back up.",
    },
  },
  {
    id: 1,
    ...
    payload: {
      ...
      instructions:
        "Stand with feet around shoulder width, sit hips back, keep chest tall, and stand up.",
    },
  },
  {
    id: 2,
    ...
    payload: {
      ...
      instructions:
        "Keep elbows under shoulders and hold a straight line from head to heels.",
    },
  },
  {
    id: 3,
    ...
    payload: {
      ...
      instructions:
        "Hinge at the hips, keep the bar close, brace, and stand tall.",
    },
  },
];
...
const evidenceSeeds: PointSeed[] = [
  {
    ...
    payload: {
      ...
      topic: "BIA",
      content:
        "BIA measurement is more reliable when hydration, food intake, recent exercise, and room conditions are standardized.",
  ...
  },
  {
    ...
    payload: {
      ...
      topic: "BIA",
      content:
        "For BIA or InBody checks, compare repeated measurements under the same conditions rather than overreacting to one reading.",
      tags: ["bia", "inbody"],
      source_file: "docker/test/seed-rag",
...
const knowledgeSeeds: PointSeed[] = [
  {
    ...
    payload: {
      ...
      contentVi:
        "Tang tien nen dua tren ky thuat tot, phuc hoi du va volume phu hop.",
      category: "training",
    },
  },
];
...
async function main(): Promise<void> {
  const vectorSize = (
    await llmService.generateEmbedding("docker test vector size")
  ).length;
