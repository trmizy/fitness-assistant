...
| Smart set-by-set prefill | P1 | TODO | Next recommended |
| Fast active-workout interaction | P1 | TODO | Pair with prefill where safe |
| Reschedule workout | P1 | TODO | Needs schedule/cycle impact analysis |
| Superset/grouping | P1 | TODO | Needs data model |
| Session resume hardening | P1 | TODO | Before full offline |
| Active-workout offline resilience | P1 | TODO | IndexedDB + idempotency |
| Custom exercises | P1 | TODO | Foundation for import |
